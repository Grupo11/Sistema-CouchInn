...
<body>
		...
		<br>
		<br>
		<input class="btn-ingresar" align="center" type="submit" value="Ingresar" ?>
		<p class="form-link1">Estas iniciando sesión en el Sistema CouchInn</p>
		<a class="centrado" href="register.php">Registrarse</a> - 
		<a class="centrado" href="recuperarPassword.php">Recuperar contraseña</a> -
